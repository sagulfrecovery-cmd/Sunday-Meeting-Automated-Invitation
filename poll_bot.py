...
if st.button("Send Attendance Poll"):
    if group_id:
        ...
        payload = {
            "chat_id": chat_target,
            "question": "يرجى الاجابة على الاستبيان، وسيتم حذف الاعضاء غير المستجيبين، والبقاء في المجموعة هم المحققين لشرط القاعدة 3.",
            "options": [
                "1) أنا عضو متابع للمجموعة والقناة",
                "2) أنا لا أعلم لماذا أنا هنا"
            ],
            "is_anonymous": False 
        }
